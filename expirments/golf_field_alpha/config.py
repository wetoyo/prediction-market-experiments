...
EXPERIMENT_NAME = "golf_field_alpha"
...
CAPITAL_FRACTION = _float_env("GOLF_FIELD_ALPHA_CAPITAL_FRACTION", 1.0)
...
_capital_cap_dollars_env = os.environ.get("GOLF_FIELD_ALPHA_CAPITAL_CAP_DOLLARS")
