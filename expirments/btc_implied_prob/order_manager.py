...
class OrderManager:
    ...
    def get_balance_dollars(self) -> float:
        ...
        to no-op), for Kelly sizing (strategy.py's _kelly_contracts). Only
        call when dry_run is False -- there's no client to query otherwise;
        strategy.py uses config.DRY_RUN_SIMULATED_BALANCE_DOLLARS in that
        case instead.
        ...
        -- NOT `balance_dollars`. ../resolution_alpha/order_manager.py's
